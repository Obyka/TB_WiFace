...
\begin{table}[H]
    ...
    \toprule
     & \textbf{NanoPC-T4} & \textbf{Raspberry Pi 4} & \textbf{ODROID-XU4} \\ \midrule
...
associée à la raspberry pi. Ce use-case étant fréquent, un module caméra officiel est proposé à la vente. Le tableau~\ref{tab:etude-marche-picamera}
